...
$typee= $_FILES['content']['type']
fileext= strtolower(end(explode('.',$filename)))
if(!in_array($filext,$fileext))
{
	echo "na ho pave";
}
*/
...
$move=move_uploaded_file($_FILES['content']['tmp_name'], $target);
sleep(10);
...
if($move) {
	...
	{
		$q= "insert into `adminstudy` (`ADSTUDY_ID`, `ADMIN_ID`, `SUBJECT_ID`, `TOPIC`, `CONTENT`) VALUES (NULL, '$email', '$subject_id', '$topic', '$Filename')";
...
<body>
	...
	<center>
	<h1><hr><font color="blue">UPLOAD NOTES FOR ANY TOPIC BY CLICKING ON IT</font>
	</center>
