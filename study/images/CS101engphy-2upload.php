...
<body>
	...
	<form action="CS101engphy-2upload.php" method="post"  enctype="multipart/form-data">

Insert Contents for any topic here <input type="file" name="content" required="yes">
