...
if(isset($_POST['email']))
{
     ...
     $SITE_POINT =0;
     $ACT_POINT =0; 
    $sel="select * from user where EMAIL_ID = '$EMAIL_ID' AND ACCOUNT_TYPE= '$ACCOUNT_TYPE' ";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-2 col-lg-4 col-lg-offset-4 form-box">
                    	<form role="form" action="Sign-up.php" method="post" class="f1">
                    		...
                    		<fieldset>
                                ...
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="dob" placeholder="Date-Of_Birth" max="2000-01-01" required="yes">
                                    </div>
                                    <div class="form-group">
                                        <label class="" for="age">Age:</label>
                                        <input type="number" class="form-control" name="age" min="17" max="80" placeholder="Age" required="yes">
                                    </div>
                                    <div class="form-group">
                                        <label class="" for="semester">Semester:</label>
                                        <input type="number" class="form-control" min="1" max="8" name="semester" placeholder="Semester" required="yes">
                                    </div>
