...
$email = $_SESSION['EMAIL_ID'];
    ...
    /*$certque = $con->prepare("SELECT CERTIFICATE FROM activity_involved WHERE ACTIVITY_ID = 6");
    $certque->execute();
    $cert= $certque->get_result();
    $r= $cert->fetch_array(MYSQLI_ASSOC);
    $CERTIFICATE= $r['CERTIFICATE'];*/
    //if($arraylist[$arrayob]['CERTIFICATE']== NULL)
