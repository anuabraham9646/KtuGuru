...
$topic= $_SESSION['topic'];
	...
	$q= "insert into `studentstudy` (`STUDY_ID`, `EMAIL_ID`, `SUBJECT_ID`, `TOPIC`, `CONTENT`, `REVIEW`) VALUES (NULL, '$email', '$subject_id', '$topic', '$content', '0')";
...
$_SESSION['topic']= $topic;
  ...
  echo '<form action="CS101engphy-2upload.php" method="post" >
      Insert link for ' .$topic. ' here <input size="30"  type="text" name="content" required="yes">
